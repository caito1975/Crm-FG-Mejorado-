// Norte CRM — icons (SVG, stroke-based, 16px default)
// Linear-style: 1.5px stroke, round joins.
...
const ICONS = {
  ...
  cmd:        '<path d="M9 6V4.5a2.5 2.5 0 1 0-2.5 2.5H9zm0 0v12m0-12h6m-6 12v1.5a2.5 2.5 0 1 1-2.5-2.5H9zm6-12V4.5a2.5 2.5 0 1 1 2.5 2.5H15zm0 0v12m0 0v1.5a2.5 2.5 0 1 0 2.5-2.5H15z"/>',
